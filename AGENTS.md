...
- Treat `README.md` as user-facing documentation. Keep it focused on what users need to download, run, configure, and interpret Pingaro; do not use it for implementation notes.
- Treat `docs/design-decisions.html` as the developer and power-user decision log. Put product behavior, architecture, measurement semantics, thresholds, persistence, build/release, and other intentional design rationale there.
